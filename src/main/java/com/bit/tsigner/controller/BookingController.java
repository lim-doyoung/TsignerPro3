...
//		System.out.println(checkOutDate);
	...
	public String roomSearch(Model model, @RequestParam("region") String region,@RequestParam("checkIn") String checkIn,@RequestParam("checkOut") String checkOut,@RequestParam(value = "persons",defaultValue = "2") String persons) throws IOException {
