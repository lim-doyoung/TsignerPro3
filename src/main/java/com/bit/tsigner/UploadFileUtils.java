...
public class UploadFileUtils {
	...
	private static String calcPath(String uploadPath) {
		...
		// 연도, ex) \\2017 
		String tPath = File.separator+"tsigner";
		String upPath = tPath+File.separator+"upload";
		String yearPath = upPath+File.separator + cal.get(Calendar.YEAR);
...
//		System.out.println(datePath);
		// 디렉토리 생성 메서드 호출
		makeDir(uploadPath, tPath,upPath, yearPath, monthPath, datePath);
//		makeDir(uploadPath, yearPath, monthPath, datePath);
	...
	private static void makeDir(String uploadPath, String... paths) {
		...
		for (String path : paths) {
			...
			System.out.println("다시보자 "+dirPath);
			// 디렉토리가 존재하지 않으면
			if (!dirPath.exists()) {
