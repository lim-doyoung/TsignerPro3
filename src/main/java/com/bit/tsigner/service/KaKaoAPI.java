...
public class KaKaoAPI {
	...
	public String getAccessToken (String authorize_code) {
		...
		try {
			...
			sb.append("&redirect_uri=http://192.168.1.8:8080/tsigner/kakao");
			//ip 주소 바꿔야함!
...
//			System.out.println("refresh_Token : "+refresh_Token);
	...
	public HashMap<String, Object> getKakaoInfo(String access_Token){
		...
		try {
			...
			try {
				profileImg =properties.getAsJsonObject().get("profile_image").toString(); 
			}catch(Exception e) {
				profileImg = null;
			}	
			...
			kakaoInfo.put("profileImg", profileImg);
