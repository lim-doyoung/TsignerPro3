...
public class EventVo {
	int event_seq, event_hits, event_origin_no, event_group_ord, event_group_layer, event_reply_cnt, event_fix;
	...
	public EventVo(int event_seq, int event_hits, int event_origin_no, int event_group_ord, int event_group_layer,
			int event_reply_cnt, String event_title, String event_content, String event_writer_id, String event_type,
			String event_file_path1, String event_file_path2, String event_file_path3, String event_file_path4,
			String event_file_path5, Timestamp regi_date, Timestamp modi_date, MultipartFile[] upload_files) {
		super();
		this.event_seq = event_seq;
		this.event_hits = event_hits;
		this.event_origin_no = event_origin_no;
		this.event_group_ord = event_group_ord;
		this.event_group_layer = event_group_layer;
		this.event_reply_cnt = event_reply_cnt;
	...
	public String toString() {
		return "EventVo [event_seq=" + event_seq + ", event_hits=" + event_hits + ", event_origin_no=" + event_origin_no
				+ ", event_group_ord=" + event_group_ord + ", event_group_layer=" + event_group_layer
				+ ", event_reply_cnt=" + event_reply_cnt + ", event_title=" + event_title + ", event_content="
				+ event_content + ", event_writer_id=" + event_writer_id + ", event_type=" + event_type
				+ ", event_file_path1=" + event_file_path1 + ", event_file_path2=" + event_file_path2
	...
	public int getEvent_origin_no() {
		return event_origin_no;
	}


	public void setEvent_origin_no(int event_origin_no) {
		this.event_origin_no = event_origin_no;
	}


	public int getEvent_group_ord() {
		return event_group_ord;
	}


	public void setEvent_group_ord(int event_group_ord) {
		this.event_group_ord = event_group_ord;
	}


	public int getEvent_group_layer() {
		return event_group_layer;
	}


	public void setEvent_group_layer(int event_group_layer) {
		this.event_group_layer = event_group_layer;
	}
	...
	public int getEvent_reply_cnt() {
		return event_reply_cnt;
	}


	public void setEvent_reply_cnt(int event_reply_cnt) {
		this.event_reply_cnt = event_reply_cnt;
	}
	
	public int getEvent_fix() {
		return event_fix;
	}


	public void setEvent_fix(int event_fix) {
		this.event_fix = event_fix;
	}
	...
	public int hashCode() {
		...
		result = prime * result + event_group_layer;
		result = prime * result + event_group_ord;
		result = prime * result + event_hits;
		result = prime * result + event_origin_no;
		result = prime * result + event_reply_cnt;
	...
	public boolean equals(Object obj) {
		...
		if (event_file_path5 == null) {
			...
			return false;
		if (event_group_layer != other.event_group_layer)
			return false;
		if (event_group_ord != other.event_group_ord)
			return false;
		if (event_hits != other.event_hits)
			return false;
		if (event_origin_no != other.event_origin_no)
			return false;
		if (event_reply_cnt != other.event_reply_cnt)
			return false;
