...
public class LoginVo {
	...
	private int user_resi_num,point;
	public int getPoint() {
		return point;
	}
	...
	private String profile_root,profile_file;
	...
	public String toString() {
		return "LoginVo [user_id=" + user_id + ", password=" + password + ", user_name=" + user_name
				...
				+ ", create_date=" + create_date + ", modi_date=" + modi_date + ", profile_root=" + profile_root
				+ ", profile_file=" + profile_file + ", files=" + Arrays.toString(files) + "]";
	}
	...
	public LoginVo(String user_id, String password, String user_name, String user_nick_name, String user_email,
			...
			Date sns_conn_date, Date create_date, Date modi_date, String profile_root, String profile_file,
			MultipartFile[] files) {
		super();
		this.user_id = user_id;
		this.password = password;
